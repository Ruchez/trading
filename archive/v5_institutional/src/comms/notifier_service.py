...
class TelegramNotifier:
    ...
    def send_trade_alert(self, symbol, action, price, mode="INTRADAY", session_count=None, reasoning=None):
        """
        Elite notification for trade execution.
        """
        emoji = "💼" if action == "BUY" else "📉"
        header = f"*POSITION OPENED*" if mode == "INTRADAY" else f"*SESSION BURST*"
